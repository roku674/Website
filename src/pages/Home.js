      ...
      <Box mt={4} display="flex" flexDirection="column" alignItems="center">
        ...
        <Box mb={4}>
          <img
            ...
            style={{ width: '150px', borderRadius: '50%', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }} /* Shadow for the profile image */
          />
        </Box>
        ...
        <Box display="flex" flexDirection="column" alignItems="flex-start" width="100%">
          ...
          <Box
            ...
            p={3}
            sx={{
              backgroundColor: '#055a72', /* Background color for the bubble */
              borderRadius: '16px', /* Rounded corners for the bubble */
              boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', /* Shadow for the bubble */
            }}
          >
            <Box mr={2}>
              <img src="/pictures/gsu.png" alt="Georgia Southern University" style={{ width: '80px', borderRadius: '8px' }} />
            </Box>
            <Typography variant="body1" color="#dde0d3">
          ...
          >
            ...
            <Typography variant="body1" color="#dde0d3">
              My computer is doo doo even though I'm a developer lol. I'm on an Intel(R) Core(TM) i7-6700 CPU @ 3.40GHz, 3401 Mhz, 4 Core(s), 8 Logical Processor(s), NVIDIA GeForce GTX 960 for my GPU. I'm currently saving up for an all-new machine, but it's over 2k and will be water-cooled :D. Check out the build I want to make <Link href="https://www.microcenter.com/site/content/custom-pc-builder.aspx?load=67c25be5-4a3a-40c1-bcde-083be28d9fd0" target="_blank" rel="noopener noreferrer" style={{ color: '#fde047' }}>here</Link>.
            </Typography>
          </Box>
        </Box>
